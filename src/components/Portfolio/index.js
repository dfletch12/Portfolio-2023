...
import bookHaven from '../../assets/images/book-haven.png'
        ...
        <>
            <div className="container portfolio-page">
                <div className="text-zone">
                    ...
                    <ul>
                        <div>
                            <a href="https://book-haven.herokuapp.com/">
                                <img className='ss' src={bookHaven} alt='A study guide app'></img>
                            </a>
                            <p> An e-commerce book store with sorting, chat, and a functional checkout. The code is available on <a href='https://github.com/Nmotley92/e-commerce-site'>GitHub</a>. </p>
                        </div>
                        <div>
